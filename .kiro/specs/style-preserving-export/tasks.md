...
- [x] 4. エクスポーターの修正（タスク 3 と並行実行可能）
- [x] 4.1 apply* 属性と xfId の出力を修正する
...
- [x] 4.2 テーマカラー・塗りつぶし・保護・アライメント・フォントの完全出力と cellStyleXfs/cellStyles 透過
...
- [x] 5. スタイルインデックス管理と統合検証
- [x] 5.1 スタイルインデックス管理ロジックを実装する
...
- [x] 5.2 ラウンドトリップ統合テストと既存テストの回帰確認
